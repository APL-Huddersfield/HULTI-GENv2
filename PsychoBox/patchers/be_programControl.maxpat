...
,
					"patching_rect" : [ 572.5, 310.0, 105.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 516.0, 214.0, 132.0, 22.0 ],
					"text" : "sel coldstart mainmenu"
				}
...
,
					"patching_rect" : [ 516.0, 265.0, 99.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 743.5, 214.0, 95.0, 22.0 ],
					"text" : "route mainmenu"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 583.0, 209.0, 153.0, 74.0 ],
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 417.5, 160.0, 77.0, 22.0 ],
													"text" : "route symbol"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "bang", "" ],
													"patching_rect" : [ 404.75, 101.0, 31.75, 22.0 ],
													"text" : "t b l"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 417.5, 201.0, 111.0, 22.0 ],
...
,
													"patching_rect" : [ 188.0, 345.0, 99.0, 22.0 ],
													"saved_object_attributes" : 													{
														"description" : "",
														"digest" : "",
														"globalpatchername" : "",
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 404.75, 48.0, 30.0, 30.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "bang", "" ],
													"patching_rect" : [ 188.0, 101.0, 53.0, 22.0 ],
													"text" : "sel okay"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 372.333333333333314, 303.0, 235.0, 22.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 372.333333333333314, 345.0, 51.0, 22.0 ],
													"text" : "pcontrol"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 188.0, 56.0, 160.0, 22.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 3,
													"outlettype" : [ "bang", "bang", "" ],
													"patching_rect" : [ 353.333333333333314, 247.0, 57.0, 22.0 ],
													"text" : "sel 0 1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 4,
													"outlettype" : [ "dictionary", "", "", "" ],
													"patching_rect" : [ 324.0, 201.0, 63.0, 22.0 ],
													"saved_object_attributes" : 													{
														"embed" : 0,
														"parameter_enable" : 0,
														"parameter_mappable" : 0
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 324.0, 160.0, 86.0, 22.0 ],
													"text" : "contains setup"
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 362.833333333333314, 285.5, 197.5, 285.5 ],
													"source" : [ "obj-17", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 414.25, 141.0, 333.5, 141.0 ],
													"source" : [ "obj-40", 0 ]
												}
...
,
					"patching_rect" : [ 743.5, 265.0, 127.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 623.0, 121.0, 260.0, 22.0 ],
