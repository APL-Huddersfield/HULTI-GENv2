...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 83.0, 336.0, 131.0, 22.0 ],
									"text" : "prepend outputchannel"
								}
...
,
					"patching_rect" : [ 448.0, 883.0, 99.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 16.5, 968.0, 99.0, 22.0 ],
					"text" : "dump, getrouting"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 16.5, 1022.0, 85.0, 22.0 ],
					"text" : "prepend mixer"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 143.25, 968.0, 61.0, 22.0 ],
					"text" : "getangles"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 143.25, 909.5, 95.0, 22.0 ],
					"text" : "sel readsuccess"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 143.25, 871.0, 106.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 143.25, 1022.0, 118.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 349.583333333333485, 968.0, 34.0, 22.0 ],
					"text" : "save"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 263.25, 968.0, 35.0, 22.0 ],
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 16.5, 1082.5, 96.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 349.583333333333485, 885.0, 77.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 89.333333333333485, 151.0, 74.666666666666515, 20.0 ],
					"text" : "Save",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 263.25, 885.0, 77.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 151.0, 74.666666666666515, 20.0 ],
					"text" : "Load",
					"textoncolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"textovercolor" : [ 0.101960784313725, 0.411764705882353, 0.796078431372549, 1.0 ],
					"usetextovercolor" : 1
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 53.0, 194.0, 41.0, 20.0 ],
					"text" : "Out #"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 541.833333333333258, 181.0, 135.0, 62.0 ],
					"text" : "binauraliser resize $1, binauraliser getangles, mixer dump, mixer getrouting"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 595.833333333333258, 138.0, 63.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 541.833333333333258, 63.0, 61.0, 22.0 ],
					"text" : "route size"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 541.833333333333258, 26.5, 106.0, 22.0 ],
					"text" : "r toAudioEngineUI"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 541.833333333333258, 97.5, 41.0, 22.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 541.833333333333258, 138.0, 52.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 542.0, 627.0, 165.0, 62.0 ],
					"text" : "binauraliser preset $1, binauraliser size, binauraliser getangles, mixer dump, mixer getrouting"
				}
...
,
					"patching_rect" : [ 554.0, 883.0, 94.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 758.249999999999773, 808.0, 34.0, 22.0 ],
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 758.249999999999773, 761.5, 61.0, 22.0 ],
					"text" : "dspstate~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 448.0, 959.5, 129.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 574.0, 808.0, 139.0, 22.0 ],
					"text" : "route routing angles size"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 574.0, 761.5, 106.0, 22.0 ],
					"text" : "r toAudioEngineUI"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 654.0, 883.0, 97.0, 22.0 ],
					"text" : "numchannels $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 758.249999999999773, 883.0, 35.0, 22.0 ],
					"text" : "getid"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 104.5, 98.5, 127.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 15.0, 215.0, 598.0, 5.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 115.0, 194.0, 90.0, 20.0 ],
					"text" : "Level control"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 538.0, 194.0, 64.0, 20.0 ],
					"text" : "Elevation"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 478.5, 194.0, 64.0, 20.0 ],
					"text" : "Azimuth"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 17.0, 194.0, 33.0, 20.0 ],
					"text" : "In #"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 477.0, 193.0, 6.0, 447.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 112.0, 193.0, 6.0, 447.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 51.0, 193.0, 6.0, 447.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 16.0, 215.0, 596.0, 424.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 41.0, 164.0, 138.0 ],
					"proportion" : 0.5,
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 430.0, 41.0, 193.0, 138.0 ],
					"proportion" : 0.5,
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 182.5, 618.0, 468.0 ],
					"proportion" : 0.5,
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 15.0, 193.0, 598.0, 447.0 ],
					"proportion" : 0.5,
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 173.0, 41.0, 253.0, 138.0 ],
					"proportion" : 0.5,
					"rounded" : 0
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 272.75, 1005.5, 152.75, 1005.5 ],
					"source" : [ "obj-129", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-135", 0 ],
					"midpoints" : [ 359.083333333333485, 1005.5, 152.75, 1005.5 ],
					"source" : [ "obj-131", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-4::obj-32::obj-1::obj-38" : [ "live.gain~[64]", "live.gain~", 0 ],
			...
			"obj-4::obj-3::obj-1::obj-38" : [ "live.gain~[73]", "live.gain~", 0 ],
			...
			"obj-4::obj-5::obj-1::obj-38" : [ "live.gain~[72]", "live.gain~", 0 ],
			...
			"obj-4::obj-9::obj-1::obj-38" : [ "live.gain~[71]", "live.gain~", 0 ],
			"parameterbanks" : 			{
