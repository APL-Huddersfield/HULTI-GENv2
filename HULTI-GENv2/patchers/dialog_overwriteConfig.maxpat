...
, 			{
				"box" : 				{
					...
					"text" : "The current configuration will be ovewritten immediately. You can't undo this action."
				}
...
, 			{
				"box" : 				{
					...
					"text" : "A test configuration file has already been loaded. Do you want to overwrite this?"
				}
